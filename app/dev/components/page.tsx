...
import { getLegacySessionCookieName, getSessionCookieName } from "@/lib/auth"
...
export default async function DevComponentsPage() {
  ...
  const raw = jar.get(getSessionCookieName())?.value || jar.get(getLegacySessionCookieName())?.value
