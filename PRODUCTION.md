...
| `TELNYX_MESSAGING_FROM_E164` | Optional override for **outbound SMS** sender (E.164). Must exist on your Telnyx account (e.g. `+15025758166`). If wrong or missing, lyncr falls back to your first purchased line in Neon. Aliases also checked: `TELNYX_PHONE_NUMBER`, `TELNYX_FROM_NUMBER`, `TELNYX_SMS_FROM`. |
