...
type WalletPayload = {
  ...
  /** Owner-configured commission plan total, net of payouts already recorded (separate from cash collected on-site above). */
        ...
        <div className="px-4 pb-3">
          <div className="rounded-xl border border-operator/20 bg-operator/10 px-3 py-3">
            ...
            <p className="mt-1 text-2xs text-muted-foreground">
              What your pay plan still owes you — ask your manager how you're paid out.
            </p>
          </div>
        </div>
      ) : null}
