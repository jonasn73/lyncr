    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex min-h-dvh flex-col items-center justify-center gap-4 bg-background px-6">
          ...
          {dumpText ? (
            <pre className="max-h-56 max-w-lg overflow-auto rounded-lg border border-border bg-card p-3 text-left text-2xs leading-snug text-muted-foreground whitespace-pre-wrap">
              {dumpText}
            </pre>
          ) : null}
