...
// ============================================
// Auto-configures ALL of a user's phone numbers with the HeySigo TeXML webhook.
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Step 1: Find or create the HeySigo Call Router TeXML app (with outbound voice profile)
